...
% included files e.g. if logo is included in the file
...
\titlegraphic{\includegraphics[height=4cm]{titlegraphic}} % your titlegraphic as pdf or similar
\logo{\includegraphics[height=0.8cm]{logo}} % the HTWDD logo
